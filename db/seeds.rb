...
party1 = Party.create(user_id: kat.id, date: "02-15-2021", location: "228 Galapago Street", time: "18:00")
party2 = Party.create(user_id: sam.id, date: "02-16-2021", location: "228 Galapago Street", time: "20:00")
